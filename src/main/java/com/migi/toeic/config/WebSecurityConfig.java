...
import com.migi.toeic.authen.CustomAuthenticationProvider;
import com.migi.toeic.authen.JwtRequestFilter;
...
//	}
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		final String Origin = environment.getProperty("address.server");
		CorsConfiguration configuration = new CorsConfiguration();
	...
	public LocaleResolver localeResolver() {
		...
		slr.setDefaultLocale(new Locale("vn_VN"));
		return slr;
	}

	@Bean
	public MessageUtils languageUtil() {
...
//						"DELETE", "PATCH", "OPTION").allowedHeaders("*").exposedHeaders("*,Authorization").allowCredentials(true);
//	}
...
//				.antMatchers("/admin/**").hasAnyAuthority(Constants.ROLE.ADMIN)
//				.antMatchers("/student/**").hasAnyAuthority(Constants.ROLE.ADMIN,Constants.ROLE.STUDENT,Constants.ROLE.TEACHER)
